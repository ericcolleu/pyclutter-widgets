...
class Button(clutter.Group):
	...
	def __init__(self, released_background, pressed_background):
		...
		self._anim_factory = Animator(default_duration_ms=200)
		...
		self._pressed_background.connect("button-press-event", self._on_pressed)
		self._pressed_background.connect("button-release-event", self._on_released)
